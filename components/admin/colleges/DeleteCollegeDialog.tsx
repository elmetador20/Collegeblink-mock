        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-serif text-lg text-[#1C1B19] dark:text-zinc-100">Delete College?</h3>
                <p className="mt-2 text-sm text-[#6B6660] dark:text-zinc-400 leading-relaxed">
                  Are you sure you want to delete <span className="font-semibold text-[#1C1B19] dark:text-zinc-200">"{collegeName}"</span>? This action is permanent and will remove all associated courses, reviews, and admissions leads.
                </p>
              </div>
            </div>
