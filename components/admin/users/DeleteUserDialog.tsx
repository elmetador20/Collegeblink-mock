        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-serif text-lg text-[#1C1B19] dark:text-zinc-100">Delete User Account?</h3>
                <p className="mt-2 text-sm text-[#6B6660] dark:text-zinc-400 leading-relaxed">
                  Are you sure you want to delete the profile of <span className="font-semibold text-[#1C1B19] dark:text-zinc-200">"{userName}"</span>? This will permanently discard all database application logs and comments.
                </p>
              </div>
            </div>
