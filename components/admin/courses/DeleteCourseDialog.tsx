            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-[#6B6660] dark:text-zinc-400 leading-relaxed">
                  Are you sure you want to delete <span className="font-semibold text-[#1C1B19] dark:text-zinc-200">"{courseName}"</span>? This action is permanent and will detach it from all offering colleges.
                </p>
              </div>
            </div>
